...
- Даниил не выполняет прямой push в `main`; владелец-ментор может использовать
  direct push или admin merge, в том числе чтобы намеренно подготовить красное
  стартовое состояние следующего задания.
