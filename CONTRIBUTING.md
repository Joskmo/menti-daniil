...
Интеграция уже создаёт в этой ветке каталог проекта с `README.md` и
минимальным `main.py`, если такого каталога нет в `main`. Существующие файлы
проекта автоматически не изменяются.
